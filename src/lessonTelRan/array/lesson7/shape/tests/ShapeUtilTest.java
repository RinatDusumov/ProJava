package lessonTelRan.array.lesson7.shape.tests;

import lessonTelRan.array.lesson7.shape.entity.*;
import lessonTelRan.array.lesson7.shape.util.ShapeUtil;
...
public class ShapeUtilTest {
    public static void main(String[] args) {
        ...
        double expectePerimeterResult = 20 * Math.PI + 40 + 60 + 30;
        ...
        printTestResult("calculate perimeter", expectePerimeterResult, realPerimeterResult);
    }
