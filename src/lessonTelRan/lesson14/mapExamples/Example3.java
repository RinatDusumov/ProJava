...
//        System.out.println("Answer is: number " + firstElement(arr, k));
    ...
    public static int firstElement(int[] arr, int k) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            // Подсчитайте, сколько раз встречается выбранный элемент
            int count = 0;
    ...
    public static int firstElementMoreEffective (int[] arr, int k) {
         ...
         *
         * Вспомогательное пространство: O(n), потому что мы используем
         * вспомогательный массив размера n для хранения счетчика */
